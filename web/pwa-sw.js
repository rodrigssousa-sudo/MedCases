...
const SW_VERSION   = '34.0.0';
const CACHE_APP    = 'medcases-app-v34.0.0';  // ← Build 140: RichText golden PRO title + clean chat card + remove FÁRMACOS sub-chip + BottomNav separator
