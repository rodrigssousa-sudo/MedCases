...
const String _modeAnchorEstudo =
    ...
    '\n'
    'TABELA COMPARATIVA MARKDOWN — OBRIGATÓRIA NOS SEGUINTES CONTEXTOS:\n'
    '  Sempre que o usuário solicitar análises, diferenciações, paralelos ou listagens\n'
    '  de classes farmacológicas (ex: ISRS, Benzodiazepínicos, Antibióticos),\n'
    '  diagnósticos diferenciais ou critérios de elegibilidade, você DEVE estruturar\n'
    '  os dados prioritariamente em uma Tabela Comparativa GFM (GitHub Flavored Markdown).\n'
    '\n'
    '  HIERARQUIA DE COLUNAS OBRIGATÓRIA (adaptar ao tema clínico):\n'
    '  | Fármaco/Entidade | Mecanismo | Dose | Efeito Crítico | Alerta Clínico |\n'
    '  |---|---|---|---|---|\n'
    '\n'
    '  REGRAS DA TABELA:\n'
    '  • Máximo 6 colunas — nunca ultrapassar para garantir legibilidade mobile.\n'
    '  • Cabeçalhos em negrito implícito (GFM). Células: dados concisos ≤ 8 palavras.\n'
    '  • Separador obrigatório: linha de --- entre cabeçalho e corpo.\n'
    '  • A tabela substitui listas paralelas — NUNCA duplicar a mesma informação\n'
    '    em lista E tabela na mesma resposta.\n'
    '  • Após a tabela: 1 parágrafo de síntese clínica + 📌 gancho final.\n'
    '\n';
// ─────────────────────────────────────────────────────────────────────────────
