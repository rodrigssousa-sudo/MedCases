...
const List<DrugModel> drugsDatabase = [
  ...
  DrugModel(
    ...
    className: {'pt': 'Analgésico não opioide / Antipirético', 'es': 'Analgésico no opioide / Antipirético'},
...
DrugModel(
    ...
    className: {'pt': 'Analgésico / Antipirético (pirazolonico)', 'es': 'Analgésico / Antipirético (pirazolonico)'},
    category: {'pt': 'Analgésicos', 'es': 'Analgésicos'},
    route: 'VO / IV / IM',
    doseType: 'fixed',
    mgKg: 15.0,
...
DrugModel(
    ...
    className: {'pt': 'AINE – Inibidor COX não seletivo (ácido arilacético)', 'es': 'AINE – Inhibidor COX no selectivo (ácido arilacético)'},
    category: {'pt': 'Analgésicos', 'es': 'Analgésicos'},
    route: 'VO / SL / IV / IM',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Morfina',
    className: {'pt': 'Opioide – Agonista µ forte (fenantreno)', 'es': 'Opioide – Agonista µ fuerte (fenantreno)'},
...
DrugModel(
    ...
    className: {'pt': 'Opioide – Agonista µ potente (fenilpiperidina)', 'es': 'Opioide – Agonista µ potente (fenilpiperidina)'},
    category: {'pt': 'Opioides', 'es': 'Opioides'},
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Tramadol',
    className: {'pt': 'Opioide fraco / Inibidor recaptação serotonina-noradrenalina', 'es': 'Opioide débil / Inhibidor recaptación serotonina-noradrenalina'},
    category: {'pt': 'Opioides', 'es': 'Opioides'},
    route: 'VO / IV / IM',
    doseType: 'fixed',
    mgKg: 1.5,
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Ceftriaxona',
    className: {'pt': 'Cefalosporina 3ª geração (IV/IM)', 'es': 'Cefalosporina 3ª generación (IV/IM)'},
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Vancomicina',
    className: {'pt': 'Glicopeptídeo – antibiótico anti-MRSA', 'es': 'Glucopéptido – antibiótico anti-MRSA'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
...
DrugModel(
    ...
    className: {'pt': 'Ureidopenicilina + inibidor β-lactamase (anti-Pseudomonas)', 'es': 'Ureidopenicilina + inhibidor β-lactamasa (anti-Pseudomonas)'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'IV',
    doseType: 'fixed',
    mgKg: 100.0,
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Meropenem',
    className: {'pt': 'Carbapenêmico (amplo espectro, anti-Pseudomonas)', 'es': 'Carbapenémico (amplio espectro, anti-Pseudomonas)'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'IV',
    doseType: 'fixed',
    mgKg: 20.0,
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Azitromicina',
    className: {'pt': 'Macrolídeo de ação prolongada (azalídeo)', 'es': 'Macrólido de acción prolongada (azálido)'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'VO / IV',
    doseType: 'fixed',
    mgKg: 10.0,
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Ciprofloxacino',
    className: {'pt': 'Fluoroquinolona 2ª geração (anti-Gram-negativo)', 'es': 'Fluoroquinolona 2ª generación (anti-Gram-negativo)'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'VO / IV',
    doseType: 'fixed',
    mgKg: 10.0,
...
DrugModel(
    ...
    group: 'Antibióticos',
    name: 'Metronidazol',
    className: {'pt': 'Nitroimidazol – antianaeróbio / antiprotozoário', 'es': 'Nitroimidazol – antianaerobio / antiprotozoario'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'VO / IV',
    doseType: 'fixed',
    mgKg: 7.5,
...
DrugModel(
    ...
    className: {'pt': 'Vasopressor – agonista α1/β1 (catecolamina endógena)', 'es': 'Vasopresor – agonista α1/β1 (catecolamina endógena)'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Dobutamina',
    className: {'pt': 'Inotrópico – agonista β1 seletivo (catecolamina sintética)', 'es': 'Inotrópico – agonista β1 selectivo (catecolamina sintética)'},
...
DrugModel(
    ...
    className: {'pt': 'Vasopressor / Broncodilatador – agonista α/β (catecolamina)', 'es': 'Vasopresor / Broncodilatador – agonista α/β (catecolamina)'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Furosemida',
    className: {'pt': 'Diurético de alça – inibidor Na-K-2Cl', 'es': 'Diurético de asa – inhibidor Na-K-2Cl'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Amiodarona',
    className: {'pt': 'Antiarrítmico classe III (bloqueador canais K/Na/Ca)', 'es': 'Antiarrítmico clase III (bloqueador canales K/Na/Ca)'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Enalapril',
    className: {'pt': 'IECA – Inibidor da enzima conversora de angiotensina', 'es': 'IECA – Inhibidor de la enzima conversora de angiotensina'},
...
DrugModel(
    ...
    name: 'Dexametasona',
    className: {'pt': 'Corticosteroide – glicocorticoide de alta potência', 'es': 'Corticosteroide – glucocorticoide de alta potencia'},
...
DrugModel(
    ...
    name: 'Midazolam',
    className: {'pt': 'Benzodiazepínico de ação curta – sedativo/anticonvulsivante', 'es': 'Benzodiacepina de acción corta – sedante/anticonvulsivante'},
...
DrugModel(
    ...
    group: 'Neurología y Psiquiatría',
    name: 'Diazepam',
    className: {'pt': 'Benzodiazepínico de ação longa – ansiolítico/anticonvulsivante', 'es': 'Benzodiacepina de acción larga – ansiolítico/anticonvulsivante'},
...
DrugModel(
    ...
    className: {'pt': 'Antiepiléptico – bloqueador canal de Na (hidantoína)', 'es': 'Antiepiléptico – bloqueador canal de Na (hidantoína)'},
...
DrugModel(
    ...
    group: 'Neurología y Psiquiatría',
    name: 'Levetiracetam',
    className: {'pt': 'Antiepiléptico – ligante SV2A (pirrolidona)', 'es': 'Antiepiléptico – ligante SV2A (pirrolidona)'},
    category: {'pt': 'Anticonvulsivantes', 'es': 'Anticonvulsivantes'},
    route: 'IV / VO',
    doseType: 'weight',
    mgKg: 60,
...
DrugModel(
    ...
    className: {'pt': 'Insulina de ação rápida / única para uso IV', 'es': 'Insulina de acción rápida / única para uso IV'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Losartana',
    className: {'pt': 'ARA-II – Antagonista receptor angiotensina II (AT1)', 'es': 'ARA-II – Antagonista receptor angiotensina II (AT1)'},
    category: {'pt': 'Cardiovasculares', 'es': 'Cardiovasculares'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    className: {'pt': 'Diurético poupador de K+ / Antagonista aldosterona', 'es': 'Diurético ahorrador de K+ / Antagonista aldosterona'},
    category: {'pt': 'Cardiovasculares', 'es': 'Cardiovasculares'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    name: 'Fluconazol',
    className: {'pt': 'Antifúngico azólico – inibidor CYP51 (ergosterol)', 'es': 'Antifúngico azólico – inhibidor CYP51 (ergosterol)'},
...
DrugModel(
    ...
    group: 'Neurología y Psiquiatría',
    name: 'Haloperidol',
    className: {'pt': 'Antipsicótico típico – bloqueador D2 (butirofenonico)', 'es': 'Antipsicótico típico – bloqueador D2 (butirofenonico)'},
...
DrugModel(
    ...
    group: 'Endocrinología y Metabolismo',
    name: 'Metformina',
    className: {'pt': 'Biguanida – sensibilizador de insulina / antidiabético oral', 'es': 'Biguanida – sensibilizador de insulina / antidiabético oral'},
    category: {'pt': 'Endócrinos / Metabólicos', 'es': 'Endócrinos / Metabólicos'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Pantoprazol',
    className: {'pt': 'Inibidor da Bomba de Prótons (IBP – benzimidazol)', 'es': 'Inhibidor de la Bomba de Protones (IBP – bencimidazol)'},
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Ondansetrona',
    className: {'pt': 'Antiemético – antagonista seletivo 5-HT3', 'es': 'Antiemético – antagonista selectivo 5-HT3'},
    category: {'pt': 'Gastroenterológicos', 'es': 'Gastroenterológicos'},
    route: 'VO / IV / SL',
    doseType: 'fixed',
    mgKg: 0.15,
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Lactulose',
    className: {'pt': 'Laxativo osmótico – dissacarídeo não absorvível', 'es': 'Laxante osmótico – disacárido no absorbible'},
    category: {'pt': 'Gastroenterológicos', 'es': 'Gastroenterológicos'},
    route: 'VO / Retal',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    className: {'pt': 'Bloqueador neuromuscular despolarizante', 'es': 'Bloqueador neuromuscular despolarizante'},
    category: {'pt': 'Anestesiologia / Sedação', 'es': 'Anestesiología / Sedación'},
    route: 'IV',
    doseType: 'weight',
    mgKg: 1.5,
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Adenosina',
    className: {'pt': 'Antiarrítmico – agonista receptor A1 (nucleosídeo)', 'es': 'Antiarrítmico – agonista receptor A1 (nucleósido)'},
...
DrugModel(
    ...
    className: {'pt': 'Antibiótico nitrofurano – urinário específico', 'es': 'Antibiótico nitrofurano – urinario específico'},
    category: {'pt': 'Antibióticos', 'es': 'Antibióticos'},
    route: 'VO',
    doseType: 'fixed',
    mgKg: 1.5,
...
DrugModel(
    ...
    className: {'pt': 'Antiepiléptico de amplo espectro / estabilizador humor', 'es': 'Antiepiléptico de amplio espectro / estabilizador del ánimo'},
...
DrugModel(
    ...
    name: 'Naloxona',
    className: {'pt': 'Antagonista opioide – antídoto para intoxicação', 'es': 'Antagonista opioide – antídoto para intoxicación'},
    category: {'pt': 'UTI / Emergência', 'es': 'UCI / Emergencia'},
    route: 'IV / IM / SC / IN',
    doseType: 'fixed',
    mgKg: 0.01,
...
DrugModel(
    ...
    className: {'pt': 'Eletrólito – reposição de cálcio / estabilizador de membrana', 'es': 'Electrolito – reposición de calcio / estabilizador de membrana'},
    category: {'pt': 'UTI / Emergência', 'es': 'UCI / Emergencia'},
    route: 'IV',
    doseType: 'fixed',
    mgKg: 50.0,
...
DrugModel(
    ...
    group: 'Varios / Antídotos / Otros',
    name: 'Flumazenil',
    className: {'pt': 'Antagonista benzodiazepínico – antídoto BZD', 'es': 'Antagonista benzodiacepínico – antídoto BZD'},
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Ibuprofeno',
    className: {'pt': 'AINE – Inibidor COX não seletivo (ácido propiônico)', 'es': 'AINE – Inhibidor COX no selectivo (ácido propiónico)'},
...
DrugModel(
    ...
    className: {'pt': 'AINE – Inibidor COX não seletivo (ácido fenilacético)', 'es': 'AINE – Inhibidor COX no selectivo (ácido fenilacético)'},
    category: {'pt': 'Analgésicos / Anti-inflamatórios', 'es': 'Analgésicos / Antiinflamatorios'},
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Naproxeno',
    className: {'pt': 'AINE – Inibidor COX não seletivo (ácido propiônico, longa ação)', 'es': 'AINE – Inhibidor COX no selectivo (ácido propiónico, larga acción)'},
    category: {'pt': 'Analgésicos / Anti-inflamatórios', 'es': 'Analgésicos / Antiinflamatorios'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Codeína',
    className: {'pt': 'Opioide fraco – pró-fármaco da morfina (fenantreno)', 'es': 'Opioide débil – profármaco de morfina (fenantreno)'},
...
DrugModel(
    ...
    group: 'UCI – Críticos y Sedoanalgesia',
    name: 'Remifentanil',
    className: {'pt': 'Opioide ultracurto – agonista µ (metabolismo por esterases)', 'es': 'Opioide ultracorto – agonista µ (metabolismo por esterasas)'},
...
DrugModel(
    ...
    group: 'Analgésicos y Antipiréticos',
    name: 'Metadona',
    className: {'pt': 'Opioide de ação longa / antagonista NMDA (fenilheptano)', 'es': 'Opioide de larga acción / antagonista NMDA (fenilheptano)'},
...
DrugModel(
    ...
    className: {'pt': 'Diurético tiazídico – inibidor Na-Cl no TCD', 'es': 'Diurético tiazídico – inhibidor Na-Cl en TCD'},
...
DrugModel(
    ...
    className: {'pt': 'Vasodilatador arterial/venoso direto – doador de NO', 'es': 'Vasodilatador arterial/venoso directo – donante de NO'},
...
DrugModel(
    ...
    group: 'Neurología y Psiquiatría',
    name: 'Lorazepam',
    className: {'pt': 'Benzodiazepínico de meia-vida intermediária – anticonvulsivante', 'es': 'Benzodiacepina de vida media intermedia – anticonvulsivante'},
...
DrugModel(
    ...
    group: 'Neurología y Psiquiatría',
    name: 'Quetiapina',
    className: {'pt': 'Antipsicótico atípico – antagonista D2/5-HT2A (dibenzotiazepina)', 'es': 'Antipsicótico atípico – antagonista D2/5-HT2A (dibenzotiazepina)'},
    category: {'pt': 'SNC / Antipsicótico', 'es': 'SNC / Antipsicótico'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Metoclopramida',
    className: {'pt': 'Procinético / Antiemético – antagonista D2 central e periférico', 'es': 'Procinético / Antiemético – antagonista D2 central y periférico'},
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Domperidona',
    className: {'pt': 'Procinético – antagonista D2 periférico (não cruza BHE)', 'es': 'Procinético – antagonista D2 periférico (no cruza BHE)'},
...
DrugModel(
    ...
    group: 'Gastroenterología',
    name: 'Loperamida',
    className: {'pt': 'Antidiarreico – agonista opioide µ periférico', 'es': 'Antidiarreico – agonista opioide µ periférico'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Dopamina',
    className: {'pt': 'Vasopressor/inotrópico – agonista D1/β1/α1 dose-dependente', 'es': 'Vasopresor/inotrópico – agonista D1/β1/α1 dosis-dependiente'},
...
DrugModel(
    ...
    group: 'Endocrinología y Metabolismo',
    name: 'Insulina NPH',
    className: {'pt': 'Insulina de ação intermediária (protamina neutra Hagedorn)', 'es': 'Insulina de acción intermedia (protamina neutra Hagedorn)'},
...
DrugModel(
    ...
    className: {'pt': 'Insulina análoga de ação prolongada (sem pico)', 'es': 'Insulina análoga de acción prolongada (sin pico)'},
    category: {'pt': 'Endocrino / Antidiabético', 'es': 'Endocrino / Antidiabético'},
    route: 'SC',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    className: {'pt': 'Hormônio pancreático / Antídoto hipoglicemia / Anti-β-bloqueador', 'es': 'Hormona pancreática / Antídoto hipoglucemia / Anti-β-bloqueador'},
...
DrugModel(
    ...
    group: 'Infectología (Antifúngicos / Antivirales / TBC)',
    name: 'Anfotericina B',
    className: {'pt': 'Antifúngico poliênico – formação de poros na membrana fúngica', 'es': 'Antifúngico poliénico – formación de poros en membrana fúngica'},
...
DrugModel(
    ...
    className: {'pt': 'Adsorvente gastrointestinal – antídoto universal', 'es': 'Adsorbente gastrointestinal – antídoto universal'},
...
DrugModel(
    ...
    group: 'Cardiovascular y HTA',
    name: 'Carvedilol',
    className: {'pt': 'Betabloqueador não seletivo + bloqueador α1 (carvedilol)', 'es': 'Betabloqueador no selectivo + bloqueador α1 (carvedilol)'},
    category: {'pt': 'Cardiovascular', 'es': 'Cardiovascular'},
    route: 'VO',
    doseType: 'fixed',
    fixedDose: {
...
DrugModel(
    ...
    className: {'pt': 'Antiepiléptico IV – ácido valproico endovenoso', 'es': 'Antiepiléptico IV – ácido valproico endovenoso'},
    category: {'pt': 'Neurologia', 'es': 'Neurología'},
    route: 'VO / IV',
...
DrugModel(
    ...
    group: 'UCI – Críticos y Sedoanalgesia',
    name: 'Esmolol',
    className: {'pt': 'Betabloqueador β1-seletivo de ação ultracurta (T½ 9 min)', 'es': 'Betabloqueador β1-selectivo de acción ultracorta (T½ 9 min)'},
    category: {'pt': 'Cardiovascular', 'es': 'Cardiovascular'},
    route: 'IV',
    doseType: 'weightBased',
    fixedDose: {
...
DrugModel(
    ...
    group: 'UCI – Críticos y Sedoanalgesia',
    name: 'Milrinona',
    className: {'pt': 'Inodilatador – inibidor de fosfodiesterase III (PDE-3)', 'es': 'Inodilatador – inhibidor de fosfodiesterasa III (PDE-3)'},
    category: {'pt': 'Cardiovascular', 'es': 'Cardiovascular'},
    route: 'IV',
    doseType: 'weightBased',
    fixedDose: {
...
DrugModel(
    ...
    className: {'pt': 'Bloqueador neuromuscular não despolarizante (aminoesteroide)', 'es': 'Bloqueador neuromuscular no despolarizante (aminoesteroide)'},
    category: {'pt': 'Emergência', 'es': 'Emergencia'},
    route: 'IV',
    doseType: 'weight',
    mgKg: 0.6,
