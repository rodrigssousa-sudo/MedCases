// MEDCASES_PRODUCTIVE_SECOND_BRAND_B1_V2_R1_HEPATO
...
class _HepatologyBodyState extends State<_HepatologyBody>
  ...
  // ── Deeplink ──────────────────────────────────────────────────────────────
  // BUILD 444 [P2+P3]: URL dinâmica Hepatologia → /?modulo=hepatologia.
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.layers_outlined, color: _kPetroleo, size: 20),
...
class _ResultsSection extends StatelessWidget {
  ...
  String _meldInterpretation(int score, bool es) {
    if (score <= 9)
      return es ? 'Mortalidad 90 días ~1–2%' : 'Mortalidade 90 dias ~1–2%';
    if (score <= 18)
      return es ? 'Mortalidad 90 días ~6%' : 'Mortalidade 90 dias ~6%';
    if (score <= 24)
      return es ? 'Mortalidad 90 días ~19%' : 'Mortalidade 90 dias ~19%';
    if (score <= 29)
      return es ? 'Mortalidad 90 días ~52%' : 'Mortalidade 90 dias ~52%';
    if (score <= 39)
      return es ? 'Mortalidad 90 días ~71%' : 'Mortalidade 90 dias ~71%';
...
// LIGHT_MODE_PREMIUM_V1_A_R14_HEPATO_SECTIONLABEL_SECTION
...
// LIGHT_MODE_PREMIUM_V1_A_R14_HEPATO_FIELDBOX
class _FieldBox extends StatelessWidget {
  ...
  IconData get _fieldIcon {
    ...
    if (normalized.contains('tp ') || normalized.contains('inr')) {
      return Icons.timer_outlined;
    }
    if (normalized.contains('nódulo') || normalized.contains('nodulo')) {
          ...
          builder: (context, _) {
            ...
            return AnimatedContainer(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Icon(Icons.straighten, size: 17, color: activeIcon),
                  const SizedBox(width: 10),
                  Expanded(
                    child: TextFormField(
                      focusNode: node,
      ...
      child: Row(
        children: [
          ...
          Switch.adaptive(
            ...
            activeColor: const Color(0xFF0D6B57),
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: active
                          ? const Color(0xFF0D6B57)
                          : (dark ? const Color(0xFF374151) : border),
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: value
              ...
              : (dark ? const Color(0xFF2A3039) : const Color(0xFFEDF1F4)),
          width: value ? 1.5 : 1.0,
        ),
      ),
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
...
class _HepEngine {
  ...
  static int _meldNa({
    ...
    final meldNaRaw =
        meldI + 1.32 * (137.0 - safeNa) - (0.033 * meldI * (137.0 - safeNa));
