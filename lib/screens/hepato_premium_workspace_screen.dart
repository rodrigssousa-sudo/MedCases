...
import 'hepato_score_detail_screen.dart';
...
class HepatoPremiumWorkspaceScreen extends StatelessWidget {
  const HepatoPremiumWorkspaceScreen({super.key});
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      isEs ? 'Scores hepáticos' : 'Scores hepáticos',
                      style: TextStyle(
                        color: text,
                        fontSize: 20,
                        height: 1.1,
                    ...
                    _ScoreGrid(
                      ...
                      items: [
                        ...
                        const _ScoreItem(
                          id: HepatoScoreId.childPugh,
                          icon: Icons.analytics_outlined,
                          title: 'Child-Pugh',
                          subtitle: 'Reserva hepática',
                          badge: 'A–C',
                        ),
                      ],
                    ),
                    ...
                    _SectionLabel(
                      dark: dark,
                      title: isEs
                          ? 'FIBROSIS · ESTRATIFICACIÓN'
                          : 'FIBROSE · ESTRATIFICAÇÃO',
                    ),
                    const SizedBox(height: 8),
                    _ScoreGrid(
                      dark: dark,
                      items: [
                        const _ScoreItem(
                          id: HepatoScoreId.fib4,
                          icon: Icons.analytics_outlined,
                          title: 'FIB-4',
                          subtitle: 'Fibrosis avanzada',
                          badge: 'FIB-4',
                        ),
                      ],
                    ),
                    ...
                    _ScoreGrid(
                      ...
                      items: [
                        ...
                        const _ScoreItem(
                          id: HepatoScoreId.lille,
                          icon: Icons.analytics_outlined,
                          title: 'Lille',
                          subtitle: 'Respuesta a corticoides',
                          badge: '0–1',
                        ),
                      ],
                    ),
        ...
        return _ScoreCatalogCard(
          ...
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => HepatoScoreDetailScreen(
                  scoreId: item.id,
                ),
              ),
            );
...
class _ScoreCatalogCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        key: ValueKey<String>('hepato_catalog_${item.id.name}'),
