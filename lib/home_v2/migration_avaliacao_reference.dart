    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          final filled = _sectionHasData(section);
          final foreground = active
              ? text
              : (filled ? section.color : secondary);
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      section.icon,
                      size: 15,
                      color: active ? section.color : foreground,
                    ),
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            style: TextStyle(
              fontSize: options.isEmpty ? 13 : 12,
              fontWeight: FontWeight.w500,
              color: text,
            ),
            decoration: fieldDecoration(
              ...
              contentPadding: EdgeInsets.symmetric(
                horizontal: options.isEmpty ? 12 : 10,
                vertical: options.isEmpty ? 11 : 9,
              ),
            ),
          ),
        ],
